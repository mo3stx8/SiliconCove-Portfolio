            ...
            {perkKeys.map((key, i) => {
              ...
              return (
                <div key={key} className="card group text-center">
                  ...
                  <p className="text-steel text-sm">{t(messages, `careers.perks.${key}.desc`)}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="py-20 bg-surface">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="card max-w-2xl mx-auto text-center py-12">
            <p className="text-lg text-steel leading-relaxed">{t(messages, 'careers.positions.comingSoon')}</p>
          </div>
        </div>
      </section>
