    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h3 className="text-2xl font-bold text-navy dark:text-white mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
                {t(messages, 'about.mission.title')}
              </h3>
              <p className="text-steel dark:text-gray-400 leading-relaxed text-lg">{t(messages, 'about.mission.text')}</p>
            </div>
            <div className="card">
              <div className="w-14 h-14 rounded-xl bg-electric/10 flex items-center justify-center mb-6">
              ...
              <p className="text-steel dark:text-gray-400 leading-relaxed text-lg">{t(messages, 'about.vision.text')}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map(({ icon: Icon, key }) => (
              <div key={key} className="card group text-center">
                ...
                <p className="text-steel dark:text-gray-400">{t(messages, `about.values.${key}.desc`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-navy to-navy-light dark:from-[#0f172a] dark:to-[#1e293b] rounded-3xl p-12 lg:p-16">
