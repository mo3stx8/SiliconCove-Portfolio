  ...
  return (
    <>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-navy to-navy-light dark:from-[#0f172a] dark:to-[#1e293b] rounded-3xl p-12 lg:p-16 text-white">
            ...
            {featureKeys.map((key, i) => {
              ...
              return (
                <div key={key} className="card group">
                  ...
                  <p className="text-steel dark:text-gray-400 leading-relaxed">{t(messages, `products.manarah.features.${key}.desc`)}</p>
                </div>
              );
            })}
          </div>
